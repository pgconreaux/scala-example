...
class ListsSuite extends FunSuite {
  ...
  test("sum of list with negative") {
    assert(sum(List(-1,2,0)) === 1)
  }
  
  test("sum of list with repeats") {
    assert(sum(List(2,2,0)) === 4)
  }
  
  test("sum of list with zeroes") {
  ...
  test("max of list with negative") {
    assert(max(List(3, -7, 2)) === 3)
  }
  
  test("max of list with repeats") {
    assert(max(List(3, 3, 2)) === 3)
  }
  
  test("max of list with zeroes") {
    assert(max(List(0, 0, -2)) === 0)
  }
  
  test("max of empty list throws no such element") {
